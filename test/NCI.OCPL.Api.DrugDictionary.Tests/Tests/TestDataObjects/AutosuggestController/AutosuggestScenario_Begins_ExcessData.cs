...
{
    /// <summary>
    /// Test data for a Begins match where the Begins and only part of the
    /// Contains results are required to produces enough results.
    /// </summary>
    public class AutosuggestScenario_Begins_ExcessData : BaseAutosuggestControllerScenario
    {
